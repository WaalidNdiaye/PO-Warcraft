...
public class Wave {
	...
	public static void gameEnd() {
		if(World.getNbWaves() == World.getCurrentW() && World.getTimeWave() >= timeEnd && World.getMonsters().size() == 0) {
	...
	public static void nextWave(){
		...
		case 1:
			if(World.getNbWaves() > 1 && World.getCurrentW() == 1 && World.getTimeWave() >= 280 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave1.png", 1, 1);
				World.setPause(true);
			}
		case 2:
			if(World.getNbWaves() > 2 && World.getCurrentW() == 2 && World.getTimeWave() >= 680 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave2.png", 1, 1);
				World.setPause(true);
			}
		case 3:
			if(World.getNbWaves() > 3 && World.getCurrentW() == 3 && World.getTimeWave() >= 1140 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave3.png", 1, 1);
				World.setPause(true);
			}
		case 4:
			if(World.getNbWaves() > 4 && World.getCurrentW() == 4 && World.getTimeWave() >= 1240 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave4.png", 1, 1);
				World.setPause(true);
			}
		case 5:
			if(World.getNbWaves() > 5 && World.getCurrentW() == 5 && World.getTimeWave() >= 2530 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave5.png", 1, 1);
				World.setPause(true);
			}
		case 6:
			if(World.getNbWaves() > 6 && World.getCurrentW() == 6 && World.getTimeWave() >= 3250 && World.getMonsters().size() == 0) {
				StdDraw.picture(0.5, 0.5, "images/wave/wave6.png", 1, 1);
				World.setPause(true);
			}
		case 7:
			if(World.getNbWaves() > 7 && World.getCurrentW() == 7 && World.getTimeWave() >= 4830 && World.getMonsters().size() == 0) {
	...
	public static int initTimeEnd(){
		return World.getNbWaves() == 1 ? 280
				: World.getNbWaves() == 2 ? 680
				: World.getNbWaves() == 3 ? 1140
				: World.getNbWaves() == 4 ? 1240
